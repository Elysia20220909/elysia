...
export declare class ElysiaTransformDecodeBuilder<T extends TSchema> {
	...
	Decode<U, D extends TransformFunction<StaticDecode<T>, U>>(
		decode: D,
...
export interface TransformOptions<I extends TSchema = TSchema, O = unknown> {
	Decode: TransformFunction<StaticDecode<I>, O>;
	Encode: TransformFunction<O, StaticDecode<I>>;
}
export interface TTransform<I extends TSchema = TSchema, O = unknown>
	extends TSchema {
	static: O;
